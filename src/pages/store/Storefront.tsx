...
const Storefront = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main>
        <section id="home" className="relative h-[390px] overflow-hidden bg-[#eaf7ff] sm:h-[430px] lg:h-[450px]">
          <img src="/hero-generated.jpg" alt="Urban Shine cleaning products" className="absolute inset-0 h-full w-full object-cover object-center" />
        </section>
